...
import { save, edit } from "../../api/master/approval_line/list";
...
const ProcessApprovalLine = (props: any) => {
    ...
    useEffect(() => {
        ...
        router.push('/master/approval_line')
    },[])
...
export const getServerSideProps: GetServerSideProps = async (ctx) => {
    ...
    const trueRole = await pageCheck(session.username, '/master/approval_line')
