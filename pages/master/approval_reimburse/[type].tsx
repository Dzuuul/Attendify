...
import { save, edit, removeReim } from "../../api/master/approval_reimburse/list";
import { useApp } from "../../../context/AppContext";

const ProcessApprovalReimburse = (props: any) => {
    ...
    useEffect(() => {
        ...
        router.push('/master/approval_reimburse')
    },[])
...
export const getServerSideProps: GetServerSideProps = async (ctx) => {
    ...
    const trueRole = await pageCheck(session.username, '/master/approval_reimburse')
    ...
    if (submit) {
        ...
        if (query.type == "delete") {
            const delDay: any = await removeReim(param, session);
...
ProcessApprovalReimburse.getLayout = function getLayout(page: ReactElement) {
    return (
        <DashboardLayout>{page}</DashboardLayout>
    )
}

export default ProcessApprovalReimburse;