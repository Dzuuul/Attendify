...
import { save, deleteDayoff, edit } from "../../api/master/dayoff/list";
import { useApp } from "../../../context/AppContext";

const ProcessDayoff = (props: any) => {
...
export const getServerSideProps: GetServerSideProps = async (ctx) => {
    ...
    const trueRole = await pageCheck(session.username, '/master/dayoff')
...
ProcessDayoff.getLayout = function getLayout(page: ReactElement) {
    return (
        <DashboardLayout>{page}</DashboardLayout>
    )
}

export default ProcessDayoff;