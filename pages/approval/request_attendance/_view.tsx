    ...
    useEffect(() => {
        ...
        setStates({
            form: {
                ...states.form,
                type: data.type,
                start_date: moment(props.data.start_date).format('DD-MM-YYYY'),
                end_date: moment(props.data.end_date).format('DD-MM-YYYY'),
                start_time: moment(props.data.start_time, 'HH:mm:ss').format('HH:mm'),
                end_time: moment(props.data.end_time, 'HH:mm:ss').format('HH:mm'),
