...
import { reqAttendance } from "../api/attendance/list";
...
const ProcessUser = (props: any) => {
    ...
    useEffect(() => {
        ...
        router.push("/attendance/request_attendance");
    }, []);
...
export const getServerSideProps: GetServerSideProps = async (ctx) => {
    ...
    const result = await axios.get(`http://www.geoplugin.net/json.gp?ip=${clientIp}`)
    ...
    if (
        ...
        if (submit) {
            ...
            const saveData: any = await reqAttendance(param, session);
