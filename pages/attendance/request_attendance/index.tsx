...
import { getData } from "../../api/attendance/request_attendance/list";
import { IState, IPagination } from "../../../interfaces/request_attendance.interface";
...
const RequestTimeOff = (props: any, { fallback }: any) => {
    ...
    const url = `/api/attendance/request_attendance/list?page=${states.data.page}&row=${states.data.row}&column=${states.filter.columns}&direction=${states.filter.directions}&key=${states.filter.key}&employeeId=${states.userId}&startDate=${states.filter.startDate}&endDate=${states.filter.endDate}`
    ...
    useEffect(() => {
        ...
        if (router.query) {
            router.push({
                pathname: '/attendance/request_attendance',
                query: {}
...
export const getServerSideProps: GetServerSideProps = async (ctx) => {
    ...
    return {
        props: {
            fallback: {
                '/api/attendance/request_attendance/list': JSON.parse(JSON.stringify(data))
            },
